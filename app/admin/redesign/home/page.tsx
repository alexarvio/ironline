...
// The redesign drafts, opened on Home. Read-only: nothing here saves.
// Local only, not for live.
//   /admin/redesign/home?client=ID
export const dynamic = "force-dynamic";

export default async function HomeRedesignPage({ searchParams }: { searchParams: Promise<{ client?: string; week?: string; program?: string; phase?: string }> }) {
