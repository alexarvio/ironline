...
//   /admin/redesign/meetings?client=ID
export const dynamic = "force-dynamic";

export default async function MeetingsRedesignPage({ searchParams }: { searchParams: Promise<{ client?: string; week?: string; program?: string; phase?: string }> }) {
