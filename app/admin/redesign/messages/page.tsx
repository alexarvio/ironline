...
// The redesign drafts, opened on Messages. Read-only: nothing here saves.
// Local only, not for live.
//   /admin/redesign/messages?client=ID
export const dynamic = "force-dynamic";

export default async function MessagesRedesignPage({ searchParams }: { searchParams: Promise<{ client?: string; week?: string; program?: string; phase?: string }> }) {
