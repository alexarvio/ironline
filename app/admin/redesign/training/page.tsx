...
// The redesign drafts, opened on Training. Read-only: nothing here saves.
// Local only, not for live.
//   /admin/redesign/training?client=ID&week=N&program=ID
export const dynamic = "force-dynamic";

export default async function TrainingRedesignPage({ searchParams }: { searchParams: Promise<{ client?: string; week?: string; program?: string; phase?: string }> }) {
